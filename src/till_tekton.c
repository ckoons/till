...
int generate_tekton_env(install_options_t *opts) {
    ...
    while (fgets(line, sizeof(line), fp_in)) {
        ...
        /* Handle base port configuration - MUST come before generic _PORT check */
        ...
        /* Handle component port assignments */
        else if (strstr(key, "_PORT") != NULL && strcmp(key, "TEKTON_PORT_BASE") != 0 && strcmp(key, "TEKTON_AI_PORT_BASE") != 0) {
